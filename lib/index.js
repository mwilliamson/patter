...
function createUtilities(createPromise) {
    ...
    function foldLeft(array, initialValue, iterator) {
        var accumulator = initialValue;
        return forEachSeries(array, function(element, index) {
            return iterator(accumulator, element, index).then(function(result) {
                accumulator = result;
            });
        }).then(function() {
            return accumulator;
